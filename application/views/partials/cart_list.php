...
?>
                        <li class="d-flex gap-5 align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center gap-4">
                                <form id="form_update" action="/products/update_cart_item/<?= $item['cart_id'] ?>" method="POST" class="d-flex gap-4">
                                    <label>
                                        <p>Quantity</p>
                                ...
                                <a class="del" href="/products/remove_item/<?= $item['cart_id'] ?>" class="border border-top-0 border-bottom-0 border-end-0"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="red" xmlns:v="https://vecta.io/nano"><path d="M14 1.41L12.59 0L7 5.59L1.41 0L0 1.41L5.59 7L0 12.59L1.41 14L7 8.41L12.59 14L14 12.59L8.41 7L14 1.41Z" fill="#cadced"/></svg></a>
                            </div>
                        </li>
<?php
    }
